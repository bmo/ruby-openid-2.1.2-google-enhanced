...
class ConsumerController < ApplicationController
  ...
  def start
    ...
    if params[:google_email_extension]             # construct the request to get email from 
  ...
  def complete
    ...
    when OpenID::Consumer::SUCCESS
      ...
      flash[:success] <<  " Email address provided is #{ax_resp['http://axschema.org/contact/email']}" if ax_resp
